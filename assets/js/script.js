...
symbolplayer[0].addEventListener('click', function(e) {
  playerchoice = 0;
  resetbtn(0,'#153243', 'solid 6px #76d495');

})

symbolplayer[1].addEventListener('click', function(e) {
  playerchoice = 1;
  resetbtn(1,'#153243', 'solid 6px #76d495');
})

symbolplayer[2].addEventListener('click', function(e) {
  playerchoice = 2;
...
myButton.addEventListener("click", function () {
 ...
 if ((playerchoice === 0 && botchoice === 2) || (playerchoice === 1 && botchoice === 0) || (playerchoice === 2 && botchoice === 1) ) {
...
//   victory.innerHTML = i++;
// }
// else if (resultat.innerHTML='perdu') {
//   lose.innerHTML = i++;
// }
// else if (resultat.innerHTML='égalité') {
//   draw.innerHTML = i++;
// }
